...
namespace FMOD
{
    public class ChannelGroup
    {
        ...
        {
            return FMOD_ChannelGroup_GetDSPClock(channelgroupraw, ref dspclock, ref parentclock);
        }
        ...
        private static extern RESULT
            FMOD_ChannelGroup_GetDSPClock(IntPtr channel, ref ulong dspclock, ref ulong parentclock);
        #endregion
